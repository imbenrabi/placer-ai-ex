      ...
      <Popover.Content>
        <Grid.Container justify='center'>
          <Row>
            ...
            <Grid>
              <Text css={{ p: "$6" }}>The mass was not found, jumping to first-year where there is a mass that fits the criteria.</Text>
            </Grid>
          </Row>
        </Grid.Container>
      </Popover.Content>
